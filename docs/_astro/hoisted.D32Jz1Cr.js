...
const Et = (t, e, n) => Math.min(Math.max(n, t), e),
	b = { duration: 0.3, delay: 0, endDelay: 0, repeat: 0, easing: 'ease' },
	V = (t) => typeof t == 'number',
	R = (t) => Array.isArray(t) && !V(t[0]),
	zt = (t, e, n) => {
		const r = e - t
		return ((((n - t) % r) + r) % r) + t
	}
function Yt(t, e) {
	return R(t) ? t[zt(0, t.length, e)] : t
}
const Tt = (t, e, n) => -n * t + n * e + t,
	At = () => {},
	S = (t) => t,
	et = (t, e, n) => (e - t === 0 ? 1 : (n - t) / (e - t))
function St(t, e) {
...
function Zt(t, e = Gt(t.length), n = S) {
	...
	return (
		...
		(o) => {
			let a = 0
			for (; a < r - 2 && !(o < e[a + 1]); a++);
			let c = Et(0, 1, et(e[a], e[a + 1], o))
			return (c = Yt(n, a)(c)), Tt(t[a], t[a + 1], c)
		}
	)
}
const Lt = (t) => Array.isArray(t) && V(t[0]),
	Z = (t) => typeof t == 'object' && !!t.createAnimation,
	O = (t) => typeof t == 'function',
	Jt = (t) => typeof t == 'string',
	C = { ms: (t) => t * 1e3, s: (t) => t / 1e3 },
	Pt = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t,
	Qt = 1e-7,
	te = 12
function ee(t, e, n, r, s) {
	let o,
		a,
		c = 0
	do (a = e + (n - e) / 2), (o = Pt(a, r, s) - t), o > 0 ? (n = a) : (e = a)
	while (Math.abs(o) > Qt && ++c < te)
	return a
}
function k(t, e, n, r) {
	if (t === e && n === r) return S
	const s = (o) => ee(o, 0, 1, t, n)
	return (o) => (o === 0 || o === 1 ? o : Pt(s(o), e, r))
}
const ne =
		(t, e = 'end') =>
		(n) => {
...
function lt(t) {
	...
	if (t.startsWith('steps')) {
		...
		if (n) {
			const r = n[1].split(',')
			return ne(parseFloat(r[0]), r[1].trim())
		}
	}
	return S
}
class Dt {
	constructor(
		...
		if (
			...
			(this.repeat = 0),
			(this.playState = 'idle'),
			(this.finished = new Promise((d, g) => {
				;(this.resolve = d), (this.reject = g)
			})),
			(r = r || b.easing),
			Z(r))
		) {
			const d = r.createAnimation(n)
			;(r = d.easing), (n = d.keyframes || n), (s = d.duration || s)
		}
		;(this.repeat = c), (this.easing = R(r) ? S : lt(r)), this.updateDuration(s)
		const f = Zt(n, i, R(r) ? r.map(lt) : S)
		;(this.tick = (d) => {
			var g
			o = o
			let w = 0
			this.pauseTime !== void 0 ? (w = this.pauseTime) : (w = (d - this.startTime) * this.rate),
				(this.t = w),
				(w /= 1e3),
				(w = Math.max(w - o, 0)),
				this.playState === 'finished' && this.pauseTime === void 0 && (w = this.totalDuration)
			const h = w / this.duration
			let m = Math.floor(h),
				v = h % 1
			!v && h >= 1 && (v = 1), v === 1 && m--
			const q = m % 2
			;(u === 'reverse' || (u === 'alternate' && q) || (u === 'alternate-reverse' && !q)) &&
				(v = 1 - v)
			const I = w >= this.totalDuration ? 1 : Math.min(v, 1),
				P = f(this.easing(I))
			e(P),
				this.pauseTime === void 0 && (this.playState === 'finished' || w >= this.totalDuration + a)
					? ((this.playState = 'finished'),
						(g = this.resolve) === null || g === void 0 || g.call(this, P))
...
const Y = (t, e) => document.createElement('div').animate(t, e),
	ft = {
		cssRegisterProperty: () =>
		...
		finished: () => !!Y({ opacity: [0, 1] }, { duration: 0.001 }).finished,
		linearEasing: () => {
			try {
				Y({ opacity: 0 }, { easing: 'linear(0, 1)' })
			} catch {
				return !1
			}
			return !0
	...
	G = {},
	x = {}
for (const t in ft) x[t] = () => (G[t] === void 0 && (G[t] = ft[t]()), G[t])
const ge = 0.015,
	ye = (t, e) => {
		let n = ''
		const r = Math.round(e / ge)
		for (let s = 0; s < r; s++) n += t(et(0, r - 1, s)) + ', '
		return n.substring(0, n.length - 2)
	},
	ht = (t, e) => (O(t) ? (x.linearEasing() ? `linear(${ye(t, e)})` : b.easing) : Lt(t) ? we(t) : t),
	we = ([t, e, n, r]) => `cubic-bezier(${t}, ${e}, ${n}, ${r})`
function ve(t, e) {
...
const N = {
	get: (t, e) => {
		e = Q(e)
		let n = J(e) ? t.style.getPropertyValue(e) : getComputedStyle(t)[e]
		if (!n && n !== 0) {
			const r = _.get(e)
			r && (n = r.initialValue)
		}
	...
	set: (t, e, n) => {
		;(e = Q(e)), J(e) ? t.style.setProperty(e, n) : (t.style[e] = n)
	}
}
function Ot(t, e = !0) {
...
function Ee(t, e) {
	...
	if (Jt(s)) {
		const o = ((n = s.match(/(-?[\d.]+)([a-z%]*)/)) === null || n === void 0 ? void 0 : n[2]) || ''
		o && (r = (a) => a + o)
	}
	return r
}
...
function Ae(t, e, n, r = {}, s) {
	...
	let c,
		{
			duration: i = b.duration,
			delay: u = b.delay,
			endDelay: l = b.endDelay,
			repeat: f = b.repeat,
			easing: d = b.easing,
			persist: g = !1,
			direction: w,
	...
	const E = Q(e),
		...
		T = _.get(E)
	return (
		Ot($.animation, !(Z(d) && $.generator) && r.record !== !1),
		() => {
			const U = () => {
				var p, M
				return (M = (p = N.get(t, E)) !== null && p !== void 0 ? p : T?.initialValue) !== null &&
					M !== void 0
					? M
					: 0
			}
			...
			const ct = Ee(y, T)
			if (Z(d)) {
				const p = d.createAnimation(y, e !== 'opacity', U, E, $)
				;(d = p.easing), (y = p.keyframes || y), (i = p.duration || i)
			}
			if (
				(J(E) && (x.cssRegisterProperty() ? pe(E) : (P = !1)),
				I && !x.linearEasing() && (O(d) || (R(d) && d.some(O))) && (P = !1),
				P)
			) {
				T && (y = y.map((L) => (V(L) ? T.toDefaultUnit(L) : L))),
					y.length === 1 && (!x.partialKeyframes() || a) && y.unshift(U())
				const p = {
					delay: C.ms(u),
					duration: C.ms(i),
					endDelay: C.ms(l),
					easing: R(d) ? void 0 : ht(d, i),
					direction: w,
					iterations: f + 1,
					fill: 'both'
				}
				;(c = t.animate({ [E]: y, offset: h, easing: R(d) ? d.map((L) => ht(L, i)) : void 0 }, p)),
					c.finished ||
						(c.finished = new Promise((L, Xt) => {
							;(c.onfinish = L), (c.oncancel = Xt)
						}))
				const M = y[y.length - 1]
				c.finished
					.then(() => {
						g || (N.set(t, E, M), c.cancel())
					})
					.catch(At),
					m || (c.playbackRate = 1.000001)
			} else if (s && I)
				(y = y.map((p) => (typeof p == 'string' ? parseFloat(p) : p))),
					y.length === 1 && y.unshift(parseFloat(U())),
					(c = new s(
						(p) => {
							N.set(t, E, ct ? ct(p) : p)
						},
						y,
						Object.assign(Object.assign({}, r), { duration: i, easing: d })
					))
			else {
				const p = y[y.length - 1]
				N.set(t, E, T && V(p) ? T.toDefaultUnit(p) : p)
			}
			return (
				a && o(t, e, y, { duration: i, delay: u, easing: d, repeat: f, offset: h }, 'motion-one'),
				$.setAnimation(c),
				c && !v && c.pause(),
				c
			)
...
const Pe = (t) => t(),
	It = (t, e, n = b.duration) =>
		new Proxy({ animations: t.map(Pe).filter(Boolean), duration: n, options: e }, xe),
	De = (t) => t.animations[0],
	xe = {
		get: (t, e) => {
			const n = De(t)
...
function Ie(t) {
	return function (n, r, s = {}) {
		...
		for (let c = 0; c < o; c++) {
			...
			for (const u in r) {
				const l = Se(s, u)
				l.delay = Oe(l.delay, c, o)
				const f = Ae(i, u, r[u], l, t)
				a.push(f)
			}
		}
		return It(a, s, s.duration)
	}
}
const Me = Ie(Dt)
function ke(t, e = {}) {
...
const je = history.pushState.bind(history),
	...
	ot = () => !!document.querySelector('[name="astro-view-transitions-enabled"]'),
	kt = (t, e) => t.pathname === e.pathname && t.search === e.search
let K,
	D,
	j = !1,
	Ct
...
async function Ke(t, e) {
	try {
		...
		return s !== 'text/html' && s !== 'application/xhtml+xml'
			? null
			: { html: await n.text(), redirected: n.redirected ? n.url : void 0, mediaType: s }
	} catch {
		return null
	}
}
	...
	for (const n of t.querySelectorAll('head link[rel=stylesheet]'))
		if (
			...
			r.setAttribute('rel', 'preload'),
				...
				e.push(
					new Promise((s) => {
						;['load', 'error'].forEach((o) => r.addEventListener(o, s)), document.head.append(r)
					})
				)
		}
	return e
...
async function pt(t, e, n, r) {
	const s = (l, f) => {
			...
			if (g) return g
			if (l.matches('link[rel=stylesheet]')) {
				const w = l.getAttribute('href')
				return f.head.querySelector(`link[rel=stylesheet][href="${w}"]`)
			}
			return null
		},
		o = () => {
			...
			if (l?.closest(`[${A}]`)) {
				if (l instanceof HTMLInputElement || l instanceof HTMLTextAreaElement) {
					const f = l.selectionStart,
						d = l.selectionEnd
					return { activeElement: l, start: f, end: d }
				}
				return { activeElement: l }
			} else return { activeElement: null }
		},
		a = ({ activeElement: l, start: f, end: d }) => {
			l &&
				(l.focus(),
				(l instanceof HTMLInputElement || l instanceof HTMLTextAreaElement) &&
					((l.selectionStart = f), (l.selectionEnd = d)))
		},
		c = (l) => {
			...
			;[...l.newDocument.documentElement.attributes, ...d].forEach(({ name: h, value: m }) =>
				f.setAttribute(h, m)
			)
			for (const h of document.scripts)
				for (const m of l.newDocument.scripts)
					if (
			...
			for (const h of Array.from(document.head.children)) {
				const m = s(h, l.newDocument)
				m ? m.remove() : h.remove()
			}
			document.head.append(...l.newDocument.head.children)
			const g = document.body,
				w = o()
			document.body.replaceWith(l.newDocument.body)
			for (const h of g.querySelectorAll(`[${A}]`)) {
				const m = h.getAttribute(A),
					v = document.querySelector(`[${A}="${m}"]`)
				v && v.replaceWith(h)
			}
			a(w)
		}
	async function i(l) {
		...
		document.documentElement.setAttribute($t, l)
		const w = document.getAnimations().filter((h) => !d.includes(h) && !f(h))
		return Promise.all(w.map((h) => h.finished))
	}
	if (!j)
...
async function Vt(t, e, n, r, s) {
	...
	const o = s ? 'traverse' : r.history === 'replace' ? 'replace' : 'push'
	if ((o !== 'traverse' && st({ scrollX, scrollY }), kt(e, n) && n.hash)) {
		Nt(n, e, r, s)
		return
	}
...
function Je() {
	for (const t of ['touchstart', 'mousedown'])
		document.body.addEventListener(
			t,
			(e) => {
				X(e.target, 'tap') && at(e.target.href, { with: 'fetch', ignoreSlowConnection: !0 })
			},
			{ passive: !0 }
		)
}
			...
			r.isIntersecting
				? (o && clearTimeout(o),
					t.set(
						s,
						setTimeout(() => {
							n.unobserve(s), t.delete(s), at(s.href, { with: 'link' })
						}, 300)
					))
				: o && (clearTimeout(o), t.delete(s))
		}
	})
}
function at(t, e) {
...
;(it || rn() !== 'none') &&
	...
	document.addEventListener('submit', (t) => {
		...
		const n = e,
			r = t.submitter,
			s = new FormData(n, r)
		let o = r?.getAttribute('formaction') ?? n.action ?? location.pathname
		const a = r?.getAttribute('formmethod') ?? n.method
		if (a === 'dialog') return
		const c = { sourceElement: r ?? n }
		if (a === 'get') {
