import { _ as is } from './hoisted.D32Jz1Cr.js'
...
function As(e) {
	if (e.fragment !== null) {
		...
		const u = e.dirty
		;(e.dirty = [-1]), e.fragment && e.fragment.p(e.ctx, u), e.after_update.forEach(Te)
	}
}
function Rs(e) {
	const u = [],
...
function vs(e, u, t, r, s, a, l, n, i, f, o, h) {
	let C = e.length,
		E = a.length,
		c = C
	const _ = {}
...
function he(e, u, t, r, s, a, l, n = [-1]) {
	...
	if (
		...
		u.intro && z(e.$$.fragment), Ee(e, u.target, u.anchor, u.customElement), gu()
	}
	re(i)
}
var Ce = class {
	...
	$set(e) {
		this.$$set && !_s(e) && ((this.$$.skip_bound = !0), this.$$set(e), (this.$$.skip_bound = !1))
	}
}
function O(e) {
		...
		for (
			...
			for (; s.charCodeAt(n) === 45 && V(s.charCodeAt(n + 1)) && V(s.charCodeAt(n + 2)); ) {
				...
				for (n = f + 2, i++; V(s.charCodeAt(n)); ) {
					if (n - f > 7) return l(n, 2, 'Too long extension, expected at most 8 characters')
					n++
				}
			}
			if (!i)
				return l(n, 4, 'Empty extension, extensions must have at least 2 characters of content')
			t.extensions.push({ singleton: r.charAt(a + 1), extensions: r.slice(a + 3, n).split('-') }),
				(a = n)
		}
	} else a = 0
	if (
	...
	return {
		c() {
			l && l.c(),
				...
				g(a, 'class', 'pagefind-ui__result-excerpt pagefind-ui__loading svelte-j9e30'),
...
function Ie(e) {
	...
	return {
		c() {
			;(u = v('div')), g(u, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-j9e30')
		},
		m(t, r) {
			T(t, u, r)
		},
...
function Pe(e) {
	...
	return {
		c() {
			;(u = v('div')), t && t.c(), g(u, 'class', 'pagefind-ui__result-thumb svelte-j9e30')
		},
		m(r, s) {
	...
	return {
		...
		p(s, a) {
			a & 2 && !ce(u.src, (t = s[1].meta?.image)) && g(u, 'src', t),
				a & 2 && r !== (r = s[1].meta?.image_alt || s[1].meta?.title) && g(u, 'alt', r)
		},
		d(s) {
			s && p(u)
		}
...
function Ms(e) {
	...
	return {
		c() {
			;(u = v('li')), s.c(), g(u, 'class', 'pagefind-ui__result svelte-j9e30')
		},
		m(a, l) {
			T(a, u, l), s.m(u, null)
		},
...
var Hs = class extends Ce {
		constructor(e) {
			super(), he(this, e, Ss, Ms, fe, { show_images: 0, process_result: 4, result: 5 })
		}
	},
	ws = Hs
function Ke(e, u, t) {
	...
	return {
		c() {
			l && l.c(),
				...
				g(a, 'class', 'pagefind-ui__result-excerpt pagefind-ui__loading svelte-4xnkmf'),
	...
	return {
		...
		p(d, R) {
			if (
				...
				d[4] ? (C ? C.p(d, R) : ((C = Ye(d)), C.c(), C.m(t, f))) : C && (C.d(1), (C = null)),
				R & 8)
			) {
				E = d[3]
				let A
			...
			d[2].length ? (_ ? _.p(d, R) : ((_ = Qe(d)), _.c(), _.m(t, null))) : _ && (_.d(1), (_ = null))
		},
		d(d) {
			h && h.d(d), d && p(u), d && p(t), C && C.d(), ie(c, d), _ && _.d()
		}
	}
}
function Je(e) {
	...
	return {
		c() {
			;(u = v('div')), g(u, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-4xnkmf')
		},
		m(t, r) {
			T(t, u, r)
		},
...
function We(e) {
	...
	return {
		c() {
			;(u = v('div')), t && t.c(), g(u, 'class', 'pagefind-ui__result-thumb svelte-4xnkmf')
		},
		m(r, s) {
			T(r, u, s), t && t.m(u, null)
		},
...
function Ye(e) {
	...
	return {
		c() {
			;(u = v('p')), g(u, 'class', 'pagefind-ui__result-excerpt svelte-4xnkmf')
		},
		m(r, s) {
...
function Xe(e) {
	...
	return {
		...
		m(o, h) {
			T(o, u, h), B(u, t), B(t, r), B(r, a), B(u, n), B(u, i), (i.innerHTML = f)
		},
		p(o, h) {
...
function zs(e) {
	...
	return {
		c() {
			;(u = v('li')), s.c(), g(u, 'class', 'pagefind-ui__result svelte-4xnkmf')
		},
		m(a, l) {
			T(a, u, l), s.m(u, null)
		},
		...
		C = async (c) => {
			t(1, (n = await c.data())),
				...
				Array.isArray(n.sub_results) &&
					...
					o ? t(3, (f = h(n.sub_results.slice(1), 3))) : t(3, (f = h([...n.sub_results], 3))))
		},
...
var Os = class extends Ce {
		constructor(e) {
			super(), he(this, e, js, zs, fe, { show_images: 0, process_result: 6, result: 7 })
		}
	},
	Us = Os
function uu(e, u, t) {
...
function ru(e) {
	...
	return {
		c() {
			;(u = v('fieldset')), (t = v('legend')), (s = M(r)), (a = b())
		...
		p(i, f) {
			if ((f & 112 && r !== (r = i[4]('filters_label', i[5], i[6]) + '') && j(s, r), f & 143)) {
	...
	return {
		...
		p(k, y) {
			;(e = k),
				...
				y & 3 && K(u, 'pagefind-ui__filter-value--checked', e[0][`${e[10]}:${e[14]}`])
		},
		d(k) {
			k && p(u), (d = !1), R()
		}
...
function lu(e) {
	...
	return {
		...
		m(E, c) {
			T(E, u, c), B(u, t), (t.innerHTML = r), B(u, s), B(u, a), B(a, l), (l.innerHTML = n), B(a, i)
			for (let _ = 0; _ < C.length; _ += 1) C[_] && C[_].m(a, null)
			B(u, f)
		},
		p(E, c) {
			if (
				(c & 2 && r !== (r = E[10].replace(/^(\w)/, nu) + '') && (t.innerHTML = r),
			...
			c & 138 && o !== (o = E[7] || E[3].map(iu).includes(E[10].toLowerCase())) && (u.open = o)
		},
		d(E) {
			E && p(u), ie(C, E)
		}
	...
	return (
		...
		(e.$$.update = () => {
			if (e.$$.dirty & 258 && r && !o) {
				...
				E.length === 1 && Object.entries(E[0][1])?.length <= 6 && t(7, (h = !0))
			}
		}),
		[f, r, s, a, l, n, i, h, o, C]
	)
...
var Bu = 'Jan Claasen <jan@cloudcannon.com>',
	...
	qs = { thanks_to: Bu, comments: vu, direction: pu, strings: Tu },
	Fu = {}
F(Fu, {
	comments: () => Du,
	default: () => Vs,
...
var vt = 'Nicolas Friedli <nicolas@theologique.ch>',
	pt = '',
	Tt = 'ltr',
	Ft = {
	...
	ea = { thanks_to: vt, comments: pt, direction: Tt, strings: Ft },
	kt = {}
F(kt, {
	comments: () => bt,
	default: () => ua,
...
var pr = 'Paul van Brouwershaven',
	...
	ca = { thanks_to: pr, comments: Tr, direction: Fr, strings: kr },
	Dr = {}
F(Dr, {
	comments: () => Mr,
	default: () => fa,
...
var A0 = 'Taylan Özgür Bildik',
	...
	Ba = { thanks_to: A0, comments: R0, direction: B0, strings: v0 },
	p0 = {}
F(p0, {
	comments: () => F0,
	default: () => va,
...
var T0 = 'Vladyslav Lyshenko <vladdnepr1989@gmail.com>',
	...
	va = { thanks_to: T0, comments: F0, direction: k0, strings: D0 },
	b0 = {}
F(b0, {
	comments: () => S0,
	default: () => pa,
...
var M0 = 'Long Nhat Nguyen',
	...
	pa = { thanks_to: M0, comments: S0, direction: H0, strings: w0 },
	N0 = {}
F(N0, {
	comments: () => z0,
	default: () => Ta,
...
function _u(e) {
	...
	return (
		...
		(u = new xs({ props: a })),
		ae.push(() => ps(u, 'selected_filters', s)),
		{
			c() {
				ke(u.$$.fragment)
			},
			...
			p(l, n) {
				...
				n[0] & 32 && (i.show_empty_filters = l[5]),
					...
					!t && n[0] & 1 && ((t = !0), (i.selected_filters = l[0]), gs(() => (t = !1))),
					u.$set(i)
			},
			i(l) {
...
function cu(e) {
	...
	return (
		...
		{
			c() {
				;(u = v('div')), r.c(), g(u, 'class', 'pagefind-ui__results-area svelte-e9gkc3')
			},
			m(i, f) {
...
function Sa(e) {
	let u,
		...
		i
	function f(_, d) {
		return _[13].results.length === 0 ? ya : _[13].results.length === 1 ? Na : wa
	}
	let o = f(e),
		h = o(e),
	...
	return {
		...
		p(_, d) {
			o === (o = f(_)) && h ? h.p(_, d) : (h.d(1), (h = o(_)), h && (h.c(), h.m(u, null))),
				d[0] & 139292 &&
					((C = _[13].results.slice(0, _[17])),
					le(),
					(s = vs(s, d, E, 1, _, C, a, r, Bs, fu, null, ou)),
					ne()),
				...
				u !==
					(u =
						r[20]('many_results', r[19], r[7])
							...
							.replace(
								/\[COUNT\]/,
								new Intl.NumberFormat(r[7].language).format(r[13].results.length)
							) + '') &&
				j(t, u)
		},
		d(r) {
...
function ya(e) {
	...
	return {
		...
		p(r, s) {
			s[0] & 589952 &&
				u !== (u = r[20]('zero_results', r[19], r[7]).replace(/\[SEARCH_TERM\]/, r[16]) + '') &&
				j(t, u)
		},
		d(r) {
			r && p(t)
...
function za(e) {
	let u, t
	return (
		(u = new ws({ props: { show_images: e[2], process_result: e[4], result: e[51] } })),
		{
			c() {
				ke(u.$$.fragment)
			},
...
function ja(e) {
	let u, t
	return (
		(u = new Us({ props: { show_images: e[2], process_result: e[4], result: e[51] } })),
		{
			c() {
				ke(u.$$.fragment)
			},
...
function du(e) {
	...
	return {
		c() {
			;(u = v('p')), (r = M(t)), g(u, 'class', 'pagefind-ui__message svelte-e9gkc3')
		},
		m(s, a) {
			T(s, u, a), B(u, r)
		},
		p(s, a) {
			a[0] & 589952 &&
				t !== (t = s[20]('searching', s[19], s[7]).replace(/\[SEARCH_TERM\]/, s[16]) + '') &&
				j(r, t)
		},
		d(s) {
			s && p(u)
...
function Oa(e) {
	...
	return {
		...
		p(A, k) {
			;(!E || (k[0] & 524416 && s !== (s = A[20]('placeholder', A[19], A[7])))) &&
				g(r, 'placeholder', s),
				(!E || k[0] & 256) && (r.autofocus = A[8]),
				k[0] & 512 && r.value !== A[9] && ze(r, A[9]),
				(!E || k[0] & 524416) && n !== (n = A[20]('clear_search', A[19], A[7]) + '') && j(i, n),
				...
				(!E || (k[0] & 524416 && C !== (C = A[20]('search_label', A[19], A[7])))) &&
					g(t, 'aria-label', C),
		...
		d(A) {
			A && p(u), e[34](null), e[35](null), d && d.d(), R && R.d(), (c = !1), W(_)
		}
	}
}
...
function Ia(e, u, t) {
	...
	for (let m = 0; m < s.length; m++) r[s[m]] = { language: s[m], ...ba[m].strings }
...
`)
				...
				await m.options(H)
				for (const N of R) {
					if (!N.bundlePath) throw new Error('mergeIndex requires a bundlePath parameter')
		...
		Y0 = async () => {
			S && ((Se = await S.filters()), (!ue || !Object.keys(ue).length) && t(18, (ue = Se)))
		},
		X0 = (m) => {
			let H = {}
			return (
	...
	const Q0 = async (m, H) => {
		...
		ts = (m) => {
			m.key === 'Escape' && (t(9, (D = '')), w.blur()), m.key === 'Enter' && m.preventDefault()
		}
	function rs() {
